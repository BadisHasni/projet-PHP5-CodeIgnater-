                        ...
                        <!--li>
                            <a href="#">Film</a>
							 <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">Film Documentaire</a>
                                </li>
                                <li>
                                    <a href="#">Film Enfants</a>
                                </li>
								<li>
                                    <a href="#">Film Romantique</a>
                                </li>
								<li>
                                    <a href="#">Film Action</a>
                                </li>
								<li>
                                    <a href="#">Film Horreur</a>
                                </li>
								<li>
                                    <a href="#">Film Comédie</a>
                                </li>
								<li>
                                    <a href="#">Film Drame et Emotion</a>
                                </li>
								<li>
                                    <a href="#">Film Classique</a>
                                </li>
                            </ul>
                        </li>
                        <li>
														...
														<?php
														 ...
														 //echo validation_errors('<div class="alert alert-error">', '</div>');
														  //echo form_open('formulaire/form_perso_add');
																...
																echo form_open('front/accueil/perso'); 
																...
																<div class="row">
																	<div class="form-group" id="formul1">
																	   <div class="col-md-4">
																			...
																			<label for="exampleInputLogin"><h4><strong>Prénom</strong></h4></label>
																...
																<div class="row">
																	<div class="form-group" id="formul1">
																	   <div class="col-md-4">
																			...
																			<label for="exampleInputNom"><h4><strong>Nom :</h4></strong></label>
																		</div><!--col-md-4-->	
																...
																<div class="row">
																	<div class="form-group" id="formul1">
																	   <div class="col-md-4">
																			  ...
																			  <label for="exampleInputCivilité"><h4><strong>Civilité&nbsp;&nbsp;</h4></strong></label>
																			</div><!--col-md-4-->	
