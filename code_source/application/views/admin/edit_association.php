...
<html class="no-js">
  <head>
	...
	function myville(region,user){
		window.open("<?php echo my_url('index.php/admin/');?>editer_association/"+user+"/"+region, "_self");
	}
    </script>
					...
					<div>
                       ...
                       <?php 
                          if(isset($association)){
                                foreach ($association->result() as $row) {
								
										echo validation_errors('<div class="alert alert-error">', '</div>');
										echo form_open('form_asso_edit');
										echo  '	<div class="row">
													<div class="col-xs-2 col-sm-2 col-md-2">
														<label for="login">Login: </label>
														<input type="text" name="id_utilisateur" id="id_utilisateur" value="'.$row->id_utilisateur.'" hidden>
														<input type="text" name="login" value="'.$row->login.'" class="form-control input-sm" placeholder="Login">
													</div>
													<div class="col-xs-2 col-sm-2 col-md-2">
														<div class="form-group">
															<label for="nom_asso">Nom: </label>
															<input type="text" name="nom_asso" value="'.$row->nom_asso.'" class="form-control input-sm" placeholder="Nom">
														</div>
													</div>
													<div class="col-xs-2 col-sm-2 col-md-2">
														<div class="form-group">
															<label for="mat_asso">Matricule: </label>
															<input type="text" name="mat_asso" value="'.$row->mat_asso.'" class="form-control input-sm" placeholder="Matricule">
														</div>
													</div>
												</div>
												<div class="row">
													...
													<div class="col-xs-3 col-sm-3 col-md-3">
														<div class="form-group">
															...
															<select name="region" id="region" class="form-control" onChange="myville(this.value,'.$row->id_utilisateur.');">
