    ...
    <script>
      less = {
		...
		function myville(region,user){
			window.open("<?php echo my_url('index.php/admin/');?>editer_user/"+user+"/"+region, "_self");
		}
										...
										echo  '	<div class="row">
													...
													<div class="col-xs-2 col-sm-2 col-md-2">
														<div class="form-group">
															...
															<input type="text" name="nom" value="'.$row->nom.'" class="form-control input-sm" placeholder="Nom">
														</div>
													</div>
													<div class="col-xs-2 col-sm-2 col-md-2">
														<div class="form-group">
															<label for="prenom">Prénom: </label>
															<input type="text" name="prenom" value="'.$row->prenom.'" class="form-control input-sm" placeholder="Prénom">
														</div>
													</div>
												</div>
												<div class="row">
												...
												<div class="row">
													<div class="col-xs-3 col-sm-3 col-md-3">
														<div class="form-group">
															...
															<input type="number" name="code_postale" value="'.$row->code_postale.'" class="form-control input-sm" placeholder="code_postale">
														</div>
													</div>
													<div class="col-xs-3 col-sm-3 col-md-3">
														<div class="form-group">
