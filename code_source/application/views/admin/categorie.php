  ...
  <head>
    ...
    <script>
	  ...
	  function deleteCat(i){
		bootbox.confirm("Voulez-vous supprimer cette Catégorie ?",function(result) {
		if (result)
		{
		...
		xmlhttp.onreadystatechange=function() {
			if (xmlhttp.readyState==4 && xmlhttp.status==200) {
				bootbox.alert("La Catégorie a été supprimée", function() {
					window.open("<?php echo my_url('index.php/admin/');?>Categorie", "_self");
				});
			}
		}
		xmlhttp.open("GET","<?php echo my_url('index.php/admin/');?>delete_categorie/"+i,true);
		xmlhttp.send();
		}
		});
	}
              ...
              <div class="col-lg-12">
                <div class="box">
				  ...
				  <br/>
					...
					<div class="text-right "><a href="<?php echo my_url('index.php/admin/');?>new_categorie"><button type="button" class="btn btn-info">Ajouter une catégorie</button></a></div>
				  <br/>
                          ...
                          if(isset($categorie)){
                                ...
                                foreach ($categorie->result() as $row) {
                                  ...
                                  echo  '<tr>
                                            ...
                                            <td>'.$row->desc.'</td>
                                            <td>'.$row->parent.'</td>
                                            <td>'.'&nbsp;&nbsp;<a href="'.my_url("index.php/admin/").'editer_categorie/'.$row->id_categorie.'"><button type="button" class="btn btn-success">Editer</button></a>'.'</td>
                                            <td>'.'&nbsp;&nbsp;<button id="delete_cat" onclick="deleteCat('.$row->id_categorie.')" type="button" class="btn btn-danger">Supprimer</button>'.'</td>
                                        </tr>';
                                }
