...
<html class="no-js">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?php echo css_url("index_admin/bootstrap.min"); ?>">
	
    <!-- Font Awesome -->
	<link rel="stylesheet" href="<?php echo css_url("index_admin/font-awesome.min"); ?>">


    <!-- Metis core stylesheet -->
    <link rel="stylesheet" href="<?php echo css_url("index_admin/main.min"); ?>">
    ...
    <link rel="stylesheet" href="<?php echo css_url("index_admin/style-switcher"); ?>">
    <link rel="stylesheet/less" type="text/css" href="<?php echo less_url("index_admin/less/theme"); ?>">
    <script src=" <?php echo js_url("index_admin/less-1.7.3.min"); ?>"></script>

    <!--Modernizr 2.8.2-->
    <script src=" <?php echo js_url("index_admin/modernizr.min"); ?>"></script>
  </head>
  <body class="">
