                  ...
                  <br/>
					<div>
                       ...
                       <?php 
										...
										echo form_open('form_admin_add');
										echo  '		<div class="row">
													<div class="col-xs-3 col-sm-3 col-md-3">
														<label for="login">Login: </label>
														<input type="text" name="login" value="" class="form-control input-sm" placeholder="Login">
													</div>
													<div class="col-xs-3 col-sm-3 col-md-3">
														<div class="form-group">
															...
															<select name="type_admin" id="type_admin" class="form-control">
																...
																foreach ($type_admin->result() as $row2) {
																	echo '<option value="'.$row2->id_type_admin.'">'.$row2->nom.'</option>';
																}
																echo '
															</select>
														</div>
												...
												<div class="row">
													...
													<div class="col-xs-3 col-sm-3 col-md-3">
														<div class="form-group">
															...
															<input type="text" name="tel" value="" class="form-control input-sm" placeholder="Téléphone">
														</div>
													</div>
												</div>
												<div class="row">
