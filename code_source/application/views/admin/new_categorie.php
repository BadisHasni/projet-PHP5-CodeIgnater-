                  ...
                  <br/>
					<div>
                       ...
                       <?php 
										...
										echo form_open('form_categorie_add');
										echo  '	<div class="row">
													<div class="col-xs-2 col-sm-2 col-md-2">
														<label for="Titre">Titre: </label>
														<input type="text" name="titre" value="" class="form-control input-sm" placeholder="Titre">
													</div>
													<div class="col-xs-2 col-sm-2 col-md-2">
														<div class="form-group">
															...
															<select name="parent" id="parent" class="form-control">
																...
																foreach ($titre_categorie->result() as $row2) {
																	echo '<option value="'.$row2->id_categorie.'">'.$row2->titre.'</option>';
																}
																echo '
															</select>
														</div>
													...
													<div class="col-xs-2 col-sm-2 col-md-2">
														<div class="form-group">
															...
															<input type="number" name="position" class="form-control input-sm" placeholder="Position">
														</div>
													</div>
												</div>
												<div class="row">
