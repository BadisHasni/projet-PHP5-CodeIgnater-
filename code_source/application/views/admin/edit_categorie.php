          ...
          <div class="user-wrapper bg-dark">
            <a class="user-link" href="">
              <img class="media-object 
               user-img" width="115" height="30" alt="User Picture" src="<?php echo my_url("assets/img/logo.png"); ?>">
                ...
                <div class="box">
                  ...
                  <br/>
					<div>
                       ...
                       <?php 
							if(isset($categorieInfo)){
                                foreach ($categorieInfo->result() as $row) {
										echo validation_errors('<div class="alert alert-error">', '</div>');
										echo form_open('form_categorie_edit');
										echo  '	<div class="row">
													<div class="col-xs-2 col-sm-2 col-md-2">
														<label for="Titre">Titre: </label>
														<input type="text" name="id_categorie" id="id_categorie" value="'.$row->id_categorie.'" hidden>
													...
													<div class="col-xs-2 col-sm-2 col-md-2">
														<div class="form-group">
															...
															<select name="parent" id="parent" class="form-control">
																...
																';
																foreach ($titre_categorie->result() as $row2) {
																	echo '<option value="'.$row2->id_categorie.'"';
																		if ($row2->id_categorie == $row->parent)
																			echo 'selected';
													...
													<div class="col-xs-2 col-sm-2 col-md-2">
														<div class="form-group">
															...
															<input type="number" name="position" value="'.$row->position.'" class="form-control input-sm" placeholder="Position">
														</div>
													</div>
												</div>
												<div class="row">
